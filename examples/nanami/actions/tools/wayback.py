...
if __name__ == "__main__":
    arguments = ActionArguments(name="wayback-machine-server", transport="stdio", workspace=None, unittest=True)
    service = WaybackActionCollection(arguments)
    result = asyncio.run(service.mcp_list_archived_versions(url="www.baidu.com"))
    print(result)
