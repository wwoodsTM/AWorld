...
if __name__ == "__main__":
    arguments = ActionArguments(name="yahoo-finance", transport="stdio", workspace=None, unittest=True)
    yahoo_finance_service = YahooFinanceActionCollection(arguments)
    result = asyncio.run(yahoo_finance_service.mcp_get_stock_quote(symbol="AAPL"))
    print(result)
