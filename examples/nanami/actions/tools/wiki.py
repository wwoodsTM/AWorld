...
class WikipediaActionCollection(ActionCollection):
...
if __name__ == "__main__":
    arguments = ActionArguments(name="wikipedia", transport="stdio", workspace=None, unittest=True)

    wikipedia_service = WikipediaActionCollection(arguments)
    result = wikipedia_service.mcp_search_wikipedia("china")
    print(result)
