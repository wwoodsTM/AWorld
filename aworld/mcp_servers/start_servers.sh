...
wait $ARXIV_PID $AUDIO_PID $CODE_PID $DOCUMENT_PID $DOWNLOAD_PID $FILESYSTEM_PID $GITHUB_PID $GOOGLEMAPS_PID $IMAGE_PID $MATH_PID $REDDIT_PID $SEARCH_PID $SYMPY_PID $VIDEO_PID $PLAYWRIGHT_PID $WIKIPEDIA_PID
