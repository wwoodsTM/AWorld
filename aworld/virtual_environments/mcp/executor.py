...
from aworld.utils.common import sync_exec, sync_exec_open
...
class MCPToolExecutor(ToolActionExecutor):
        ...
        for action in actions:
            ...
            try:
                ...
                if self.mcp_servers[server_name]["instance"]:
                    print(f"---------------------------self.server {server_name} exists.")
    ...
    def execute_action(self, actions: List[ActionModel], **kwargs) -> Tuple[
        ...
        # return sync_exec_open(self.async_execute_action, actions, **kwargs)
        # await self.async_execute_action(actions, **kwargs)
        # return results, None

    # async def execute_action(self, actions: List[ActionModel], **kwargs) -> Tuple[
    #     List[ActionResult], Any]:
